namespace Gym.Utilities.Messages
{
    public static class ExceptionMessages
    {
        ...
        public const string InvalidEquipmentType = "Invalid equipmentCollection type.";

        public const string InexistentEquipment = "There isn’t equipmentCollection of type {0}.";
