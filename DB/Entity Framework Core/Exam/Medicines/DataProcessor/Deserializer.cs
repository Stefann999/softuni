        ...
        public static string ImportPharmacies(MedicinesContext context, string xmlString)
        {
            ...
            foreach (var pharmacyDto in pharmacyDtos)
            {
                ...
                foreach (var medicineDto in pharmacyDto.Medicines)
                {
                    ...
                    bool isProductionDateValid = DateTime.TryParseExact(medicineDto.ProductionDate, "yyyy-MM-dd", CultureInfo.InvariantCulture, DateTimeStyles.None, out DateTime correctProdDate);
                    ...
                    bool isExpiryDateValid = DateTime.TryParseExact(medicineDto.ExpiryDate, "yyyy-MM-dd", CultureInfo.InvariantCulture, DateTimeStyles.None, out DateTime correctExpDate);
                    ...
                    if (correctProdDate >= correctExpDate)
                    {
                        sb.AppendLine(ErrorMessage);
                        continue;
                    }
                    ...
                    pharmacy.Medicines.Add(new Medicine()
                    {
                        ...
                        ProductionDate = correctProdDate,
                        ExpiryDate = correctExpDate,
